...
public interface LetsWorkClientRepository extends JpaRepository<LetsWorkClient, Long> {
    ...
    @Transactional
    @Modifying
    @Query("DELETE FROM LetsWorkClient l WHERE l.clientCompanyName = :clientCompanyName")
    void deleteByClientCompanyName(@Param("clientCompanyName") String clientCompanyName);
