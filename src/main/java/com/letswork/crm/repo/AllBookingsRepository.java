...
@Repository
public interface AllBookingsRepository extends JpaRepository<AllBookings, Long> {

    Optional<AllBookings> findByBookingCode(String bookingCode);
