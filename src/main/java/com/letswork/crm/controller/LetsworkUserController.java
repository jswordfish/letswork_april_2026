...
public class LetsworkUserController {
	
	@Autowired
	LetsworkUserService service;
	
	@PostMapping
	public String createClient(@RequestBody LetsworkUser client, @RequestParam String token) {
...
//    }
	...
	@DeleteMapping
	public String deleteClient(@RequestBody LetsworkUser client, @RequestParam String token) {
