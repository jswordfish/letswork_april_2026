...
public class BookingController {
    ...
    public ResponseEntity<Booking> createDayPassBooking(
    ...
    public ResponseEntity<Booking> bookConferenceRoom(
            @RequestParam String token,
            @RequestBody BookConferenceRoomRequest request
    ) {

        Booking bookingRequest = request.getBooking();

        Booking booking = service.createConferenceRoomBooking(
                bookingRequest,
                request.getSlotDate(),
                request.getSlots()
        );
